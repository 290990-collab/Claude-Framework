...
class Project:
    ...
    @property
    def notes(self) -> int:
        """Le deroghe dichiarate. Si contano a parte: sono decisioni prese, non
        lavoro da fare, e sommarle agli avvisi renderebbe illeggibile la
        colonna che serve a scegliere quale progetto sistemare."""
