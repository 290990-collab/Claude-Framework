...
[DA COMPILARE — comando di esecuzione dei test, framework in uso, dove vivono i
test e come si nominano, cosa è escluso per natura e come si verifica invece,
tempi di esecuzione, dati di prova disponibili, difetti già capitati che hanno
una regressione dedicata.]
