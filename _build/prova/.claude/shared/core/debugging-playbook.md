...
Guasti ricorrenti: rotazione del file durante il follow, encoding non UTF-8, buffer non svuotato su pipe. `LOGTAIL_DEBUG=1` attiva la traccia dettagliata su stderr.
