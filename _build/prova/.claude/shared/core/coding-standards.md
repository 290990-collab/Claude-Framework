...
Python 3.11+. Formattazione con `ruff format`, analisi con `ruff check` — entrambi obbligatori prima di dichiarare finito. Annotazioni di tipo su tutto ciò che è pubblico. Nessuna dipendenza nuova senza conferma esplicita dell'utente.
