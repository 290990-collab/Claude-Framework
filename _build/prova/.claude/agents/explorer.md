...
La logica vera sta in `src/logtail/`; `tests/` contiene i test, `dist/` è generato e non si apre. I comandi sono in `pyproject.toml`. I file di log di esempio in `fixtures/` possono essere grandi: leggerne solo le prime righe.
