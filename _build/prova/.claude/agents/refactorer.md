...
`core/` ha copertura, `cli/` quasi no: lì il refactoring va fatto a piccoli passi con verifica manuale. I nomi dei sottocomandi e delle opzioni sono contratto pubblico: rinominarli rompe gli script degli utenti anche se il codice compila.
