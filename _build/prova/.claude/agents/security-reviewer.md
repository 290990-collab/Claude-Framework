...
<!-- FRAMEWORK:KERNEL v1.0.0 sha256:7131892a — generato, non modificare a mano -->
## Metodo
...
Superfici: i pattern di filtro forniti dall'utente vengono compilati come espressioni regolari (rischio di backtracking esponenziale su input ostile); i percorsi dei file di log arrivano da riga di comando e da `~/.logtail.toml`; i log possono contenere credenziali, quindi l'output non va mai inviato altrove.
